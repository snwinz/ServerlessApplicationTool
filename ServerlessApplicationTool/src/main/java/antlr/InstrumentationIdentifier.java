...
public class InstrumentationIdentifier<T> extends JavaScriptParserBaseVisitor<T> {
	...
	private boolean isAllSequencesInstrumented(){
		return criteria.stream().anyMatch(criterion -> criterion instanceof InstrumentatorARS);
	}
